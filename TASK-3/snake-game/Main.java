...
class Game extends JPanel {
    ...
    public Game() {
        ...
        setFocusable(true);
        setBackground(new Color(90, 160, 20));
    ...
    private void render(Graphics g) {
        ...
        if (status == GameStatus.NOT_STARTED) {
          ...
          drawCenteredString(g2d, "Press  ENTER  key  to  begin", FONT_M_ITALIC, 320);
        ...
        if (cherry != null) {
          if (didLoadCherryImage) {
            g2d.drawImage(image, cherry.getX(), cherry.getY(), 10, 10, null);
          } else {
            g2d.setColor(Color.BLACK);
        ...
        if (status == GameStatus.GAME_OVER) {
            drawCenteredString(g2d, "Press  ENTER KEY  to  start  again", FONT_M_ITALIC, 330);
